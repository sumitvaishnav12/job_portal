...
if(isset($_POST['saveDetails'])){
	$name=$_POST['name'];	 
	mysql_query("insert into `skills` SET `name`='$name'");	

	$_SESSION['type']="success";
	$_SESSION['message']="Skill added successfully";
	header("location:skills_master.php");
}  

if(isset($_POST['deleteAction']))
{
	$delete_id=$_POST['delete_id'];
	mysql_query("update `skills` SET `is_deleted`='1' where id='$delete_id'" );

	$_SESSION['type']="success";
	$_SESSION['message']="Skill successfully Deleted";
	header("location:skills_master.php");
} 
?> 
<?php head();?> 
						...
						<form  class="form-horizontal" id="formValidation"  role="form" method="post"> 
							<div class="box-body"> 
								<div class="form-group">
				                  ...
				                  <div class="col-sm-8">
				                    <input class="form-control" placeholder="Skill Name" required name="name" autocomplete="off" type="text">
				                  </div>
				                </div> 
					...
					<div class="portlet-body form">
						<div class="table-scrollable">
							<table id="example2" class="table table-bordered table-hover">
								...
								<tbody>
						 		<?php
						  		$getData=mysql_query("select * from `skills` where `is_deleted` = '0'");		
								$i=0;

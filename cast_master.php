...
if(isset($_POST['saveDetails'])){
	$name=$_POST['name'];	 
	mysql_query("insert into `casts` SET `name`='$name'");	

	$_SESSION['type']="success";
	$_SESSION['message']="Cast added successfully";
	header("location:cast_master.php");
}  

if(isset($_POST['deleteAction']))
{
	$delete_id=$_POST['delete_id'];
	mysql_query("update `casts` SET `is_deleted`='1' where id='$delete_id'" );

	$_SESSION['type']="success";
	$_SESSION['message']="Cast successfully Deleted";
	header("location:group_master.php");
} 
?> 
<?php head();?> 
						...
						<form  class="form-horizontal" id="formValidation"  role="form" method="post"> 
							<div class="box-body"> 
								<div class="form-group">
				                  <label for="inputEmail3" class="col-sm-4 control-label">Cast Name</label> 
				                  <div class="col-sm-8">
				                    <input class="form-control" placeholder="Cast Name" required name="name" autocomplete="off" type="text">
				                  </div>
				                </div> 
					...
					<div class="portlet-body form">
						<div class="table-scrollable">
							<table id="example2" class="table table-bordered table-hover">
								...
								<tbody>
						 		<?php
						  		$getData=mysql_query("select * from `casts` where `is_deleted` = '0'");		
								$i=0;
